...
class CreateUserUseCase:
    ...
    def execute(self, user_data: CreateUserRequest) -> None:
        ...
        if user_data.study and (
            user_data.university is None
            or user_data.degree is None
            or user_data.expected_graduation is None
        ):
        ...
        user = User(
            ...
            expected_graduation=datetime.strptime(user_data.expected_graduation, "%d/%m/%Y")
