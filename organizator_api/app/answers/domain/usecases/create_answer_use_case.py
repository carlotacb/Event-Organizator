...
class CreateAnswerUseCase:
    ...
    def execute(self, answer_data: CreateAnswerRequest) -> None:
        application = GetApplicationUseCase().execute(application_id=answer_data.application_id)
        question = GetQuestionsByIdUseCase().execute(question_id=answer_data.question_id)
