...
class UpdateQuestionUseCase:
    ...
    def execute(
        ...
        question.question = (
            question_data.question if question_data.question else question.question
        )
        question.question_type = (
            QuestionType[question_data.question_type]
            if question_data.question_type
            else question.question_type
        )
        question.options = (
            question_data.options if question_data.options else question.options
        )
