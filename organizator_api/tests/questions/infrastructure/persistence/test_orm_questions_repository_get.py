...
from app.questions.infrastructure.persistence.orm_questions_repository import ORMQuestionRepository
from tests.api_tests import ApiTests


class TestORMQuestionsRepositoryGet(ApiTests):

    def test__given_no_existing_question_in_db__when_get__then_question_does_not_exist_is_raised(self):
        # Given
    ...
    def test__given_a_question_id__when_get__then_question_information_is_returned(self) -> None:
        # Given
        event = self.given_event_in_orm(
            new_id=uuid.UUID("ef6f6fb3-ba46-43dd-a0da-95de8125b1cc"), name="event"
        )
