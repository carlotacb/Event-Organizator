...
class TestORMUserRepository(ApiTests):
    ...
    def test__when_get_all__then_all_users_are_returned(self) -> None:
        ...
        self.assertEqual(users[0].email, user2.email)
        self.assertEqual(type(users[0].email), str)
        self.assertEqual(users[0].first_name, user2.first_name)
        self.assertEqual(type(users[0].first_name), str)
        self.assertEqual(users[0].last_name, user2.last_name)
        self.assertEqual(type(users[0].last_name), str)
        self.assertEqual(users[0].username, user2.username)
        self.assertEqual(type(users[0].username), str)
        self.assertEqual(users[0].bio, user2.bio)
        self.assertEqual(type(users[0].bio), str)
        self.assertEqual(users[0].profile_image, user2.profile_image)
        ...
        self.assertEqual(users[1].email, user.email)
        self.assertEqual(users[1].first_name, user.first_name)
        self.assertEqual(users[1].last_name, user.last_name)
        self.assertEqual(users[1].username, user.username)
        self.assertEqual(users[1].bio, user.bio)
        self.assertEqual(users[1].profile_image, user.profile_image)
