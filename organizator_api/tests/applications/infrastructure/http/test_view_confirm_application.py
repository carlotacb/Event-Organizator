...
class TestViewConfirmApplication(ApiTests):
    def setUp(self) -> None:
        super().setUp()
    ...
    def test__when_confirm_application_without_header__then_unauthorized_is_returned(
        self,
    ) -> None:
        # When
        response = self.client.post(
            "/organizator-api/applications/confirm/eb41b762-5988-4fa3-8942-7a91ccb00686",
    ...
    def test__given_a_invalid_token__when_confirm_application__then_invalid_token_is_returned(
        self,
    ) -> None:
        # When
    ...
    def test__given_a_non_existing_application_id__when_confirm_application__then_application_not_found_is_returned(
        self,
    ) -> None:
        # When
    ...
    def test__given_a_valid_application_id_with_pending_status__when_confirm_application__then_application_can_not_be_confirm_is_returned(
        self,
    ) -> None:
        # Given
    ...
    def test__given_a_valid_application_and_a_token_for_another_user__when_confirm_application__then_application_is_not_from_user_is_returned(
        self,
    ) -> None:
        # Given
        application = ApplicationFactory().create(
    ...
    def test__given_a_valid_application_id_with_invited_status__when_confirm_application__then_application_is_confirmed(
        self,
    ) -> None:
        # Given
        application = ApplicationFactory().create(
        ...
        self.assertEqual(response.content, b"Application is correctly confirmed")
